...
import {
  ...
  deleteSelectListItemByIdLap,
  getAllSelectList,
  getAllSelectListLap,
  UpdateSelectListItem,
  UpdateSelectListItemLap,
...
export default function FilterMenu() {
  ...
  const onSubmit = async (data, e) => {
    await dispatch(UpdateSelectListItemLap(chooseSelectItem));
    handleCancel()
    dispatch(getAllSelectListLap())
  };
  ...
  const removeSelectItem = async (item) => {
    console.log(item)
    await dispatch(deleteSelectListItemByIdLap(item._id))
    dispatch(getAllSelectListLap())
  }
