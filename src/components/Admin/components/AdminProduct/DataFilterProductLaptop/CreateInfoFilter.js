...
import { CreateSelectListItem, CreateSelectListItemLap, getAllSelectList, getAllSelectListLap } from "../../../../../actions/SelectListAction";
...
export default function CreateInfoFilter() {
  ...
  const onSubmit = async (data, e) => {
    ...
    console.log(newData);
    await dispatch(CreateSelectListItemLap(newData));
    setAddOption([]);
    e.target.reset();
    dispatch(getAllSelectListLap())
  };
