...
import { CreateNewTypeProductLaptop, getAllTypeProductLaptop } from "../../../../../actions/ListTypeProductAction";
...
export default function CreateNewType() {
  ...
  const onSubmit = async (data, e) => {
    ...
    e.target.reset();
    await dispatch(CreateNewTypeProductLaptop(formData));
  ...
  const HandleSubMit = (e) =>{
    e.preventDefault();
    dispatch(CreateNewTypeProductLaptop(postData));
    success();
   dispatch(getAllTypeProductLaptop())
